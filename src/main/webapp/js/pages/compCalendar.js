            ...
            $('#calendar').fullCalendar({
                ...
                select: function(arg) {
                    console.log(arg);
                     ...
                     // var lafe= fecha.getFullYear()+'/'+parseInt(fecha.getMonth())+1+'/'+fecha.getDate();
                     // var options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
                     // //alert(fecha.toLocaleDateString("es-ES", options));
                     // $("#lafecha").text(fecha.toLocaleDateString("es-ES", options))
                     // $("#fecha_registro").val(convertir_Fecha(fecha));
                     //cargar_eventos(persona,convertir_Fecha(fecha));
                     //calendar.unselect()
                   }
            });
        }
