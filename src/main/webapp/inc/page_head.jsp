            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="sidebar-nav">
                                                                        <li>
                            <a href="Home" class=" active"><i class="gi gi-stopwatch sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Home</span></a>
                                                    </li>
                                                    <li>
                            <a href="Inicio"><i class="gi gi-stopwatch sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Usuario</span></a>
                                                    </li>
                                                                                                <li>
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            <li class="dropdown-header text-center">Salir del sistema</li>
                            
                            <li class="divider"></li>
                            <li>
                                <a href="page_ready_lock_screen.php"><i class="fa fa-lock fa-fw pull-right"></i> Lock Account</a>
                                <a href="Login"><i class="fa fa-ban fa-fw pull-right"></i> Salir</a>
                            </li>
